...
class StallListAdapter extends SimpleSingleItemRecyclerAdapter<StallDetails> {
    @Override
    ...
    @Override
    protected void onBindViewHolder(ViewHolder holder, StallDetails data, int position) {
