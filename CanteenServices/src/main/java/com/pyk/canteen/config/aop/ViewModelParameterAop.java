package com.pyk.canteen.config.aop;
...
public class ViewModelParameterAop {
    ...
    @Pointcut("@annotation(com.pyk.canteen.util.ump.ViewModelParameter)")
    public void viewModelParameter() {
    }

    @Pointcut("@annotation(com.pyk.canteen.util.ump.ViewModelParameters)")
